...
MKINSTALLDIRS   := /Users/martinruckert/Documents/hint/hintview/external/freetype-2.12.1/builds/unix/./install-sh -c -d
...
PKGCONFIG_LIBS_PRIVATE     := -lz -lbz2 -L/opt/local/lib -lpng16 -lz
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -L/opt/local/lib -lpng16 -lz
build_libtool_libs         := 
ft_version                 := 24.3.18
