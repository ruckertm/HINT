...
/* given a font and a character-code return a pointer to the glyph or NULL */
{
    if (cc >> G0_BITS) {
        ...
        if (cc1 >> G123_BITS) {
            ...
            } else if (pk->g2 && pk->g2[cc2 & G123_MASK] &&
                       pk->g2[cc2 & G123_MASK][cc1 & G123_MASK])
...
/* given a font and a character-code return a pointer to the glyph
