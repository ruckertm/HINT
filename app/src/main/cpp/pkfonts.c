...
{   int i,j;
	...
	while (i< pk->size)
	  switch(flag=data[i++])
	{ case pk_xxx1: j=read_1_byte(); i=i+j; break;
	  case pk_xxx2: j=read_2_byte(); i=i+j;  break;
	  case pk_xxx3: j=read_3_byte(); i=i+j;  break;
	  case pk_xxx4: j=read_4_byte(); i=i+j;  break;
