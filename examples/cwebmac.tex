...
% Modified to produce TeX the Program mr
...
\pdffalse \pdftexfalse \acrofalse % for books
...
\newdimen\pagewidth \pagewidth=35pc % the width of each page
\newdimen\pageheight \pageheight=52pc % the height of each page
\newdimen\fullpageheight 
\fullpageheight=\pageheight
\advance\fullpageheight by 0.5in % page height including headlines
...
\setpage
\vbox to \vsize{}\eject % the first \topmark won't be null
